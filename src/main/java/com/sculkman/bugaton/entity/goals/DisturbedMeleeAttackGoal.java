...
public class DisturbedMeleeAttackGoal extends MeleeAttackGoal {

    private final DisturbedEntity entity;
    private int attackDelay = 15;
    private int ticksUntilNextAttack = 30;
    private boolean shouldCountTillNextAttack = false;

    public DisturbedMeleeAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((DisturbedEntity) mob);
    }
